...
export class DiagramComponent implements OnInit, AfterViewInit {
  ...
  test() {
    console.log(this._diagramService.editor.getNodesFromName("UtilitySource").length)
  }
  saveWorkingNode() {
    console.log("Saving")
    if (this.workingFormGroup.valid) {
      ...
      this._diagramService.editor.drawflow.drawflow.Home.data[this.workingNode.id].html = "asdasdasd"
